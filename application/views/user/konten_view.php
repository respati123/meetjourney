        ...
        <div class="col-sm-12">
            <div class="row">
                ...
                <?php foreach ($user as $us): ?>
                    <div class="col-sm-6">
                        <a href="<?php echo base_url('home/read/'.url_title($us->title).'.html'); ?>">
                        <div class="card example hoverable">

                            <!--Card image-->
                            <img class="img-fluid" src="<?php echo $us->foto_konten ?>" alt="Card image cap">
                            <!--/.Card image-->

                            <!--Card content-->
                            <div class="card-block">
                                <!--Title-->
                                <h4 class="card-title"><?php echo ucwords($us->title) ?></h4>
                                <!--Text-->
                                <p class="card-text"><?php echo ucfirst($us->subtitle) ?></p>
                                <a href="<?php echo base_url('home/read/'.url_title($us->title).'.html'); ?>" class="btn btn-primary">Readm More</a>
                            </div>
                            <!--/.Card content-->
